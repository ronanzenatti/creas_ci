        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control text-center mask_CEP" maxlength="10"
                       ...
                       value="{{(isset($obj['cep']) ? $obj['cep'] : null)}}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" name="complemento" id="complemento"
                       maxlength="45" value="{{(isset($obj['complemento']) ? $obj['complemento'] : null)}}">
            </div>
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" maxlength="45" name="referencia"
                       id="referencia" value="{{(isset($obj['referencia']) ? $obj['referencia'] : null)}}">
            </div>
        </div>
        <div id="mudanca_div">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="input-group date">
                        <input type="text" class="form-control mask_date text-center datepicker"
                               ...
                               value="{{(isset($obj['dt_mudanca']) ? $obj['dt_mudanca'] : null)}}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" id="motivo" name="motivo"
                              style="resize: vertical">{{(isset($obj['motivo']) ? $obj['motivo'] : null)}}</textarea>
                </div>
            </div>
        </div>
    </form>
