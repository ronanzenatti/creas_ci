...
@section('titulo_pagina', 'Inserir Funcionário')
                        ...
                        <div class="col-sm-10">
                            <select name="identidade" class="form-control" id="identidade" required>
                                ...
                                @foreach($entidades as $e)
                                    <option value="{{$e['identidade']}}">{{$e['nome']}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="email" class="form-control" name="email" id="email" maxlength="200"
                                   value="{{(isset($objU['email']) ? $objU['email'] : null)}}" required>
                        </div>
                    </div>
                    <div class="form-group">
...
@section('js')
    <script>
        ...
        @if (isset($objU))
        $("#identidade").val("{{$objU['identidade']}}").trigger('change');
