<?php $__env->startSection('titulo_pagina', 'Listar Adolescentes'); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <a href="<?php echo e(base_url('index.php/adolescentes/inserir')); ?>" class="btn btn-success">Novo</a>
    ...
    <script>
        $(function () {
            $('table').dataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(base_url('index.php/adolescentes/Ajax_Datatables')); ?>",
                    type: "POST"
                },
