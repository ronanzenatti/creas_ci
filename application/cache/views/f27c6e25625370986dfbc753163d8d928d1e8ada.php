<?php $__env->startSection('titulo_pagina', 'Situação Habitacional'); ?>
...
<?php $__env->startSection('content'); ?>
    <table id="tableSituacao" class="table table-striped table-bordered table-hover" cellspacing="0">
        <thead>
        <tr>
            <th>#</th>
            <th>Nome</th>
    ...
    <script>
        $(function () {
            $('table').dataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(base_url('index.php/situacao_habitacional/Ajax_Datatables')); ?>",
                    type: "POST"
                },
