<?php $__env->startSection('titulo_pagina', 'Inserir Adolescente'); ?>



<?php $__env->startSection('breadcrumb'); ?>
    <a href="<?php echo e(base_url('index.php/adolescentes')); ?>" class="btn btn-default" id="voltar" name="voltar">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="natural" id="natural"
                                   maxlength="100" value="<?php echo e((isset($objP['natural']) ? $objP['natural'] : null)); ?>">
                        </div>
                    </div>
            ...
            <form role="formAdolescente" id="formAdolescente" class="form-horizontal" method="post" action="#">
                <div class="row">
                    <input type="hidden" id="idadolescente" name="idadolescente"
                           value="<?php echo e((isset($objA['idadolescente']) ? $objA['idadolescente'] : null)); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="responsavel" id="responsavel" maxlength="150"
                                   value="<?php echo e((isset($objA['responsavel']) ? $objA['responsavel'] : null)); ?>"
                                   minlength="3">
                        </div>
                    </div>
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="pai" id="pai" maxlength="150"
                                       value="<?php echo e((isset($objA['pai']) ? $objA['pai'] : null)); ?>" minlength="3">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group date">
                                    <input type="text" class="form-control mask_date text-center datepicker"
                                           ...
                                           value="<?php echo e((isset($objA['pai_nasc']) ? $objA['pai_nasc'] : null)); ?>">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="pai_natural" id="pai_natural"
                                       maxlength="50"
                                       value="<?php echo e((isset($objA['pai_natural']) ? $objA['pai_natural'] : null)); ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="mae" id="mae" maxlength="150"
                                       value="<?php echo e((isset($objA['mae']) ? $objA['mae'] : null)); ?>" F
                                       minlength="3">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group date">
                                    <input type="text" class="form-control mask_date text-center datepicker"
                                           ...
                                           value="<?php echo e((isset($objA['mae_nasc']) ? $objA['mae_nasc'] : null)); ?>">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="mae_natural" id="mae_natural"
                                       maxlength="50"
                                       value="<?php echo e((isset($objA['mae_natural']) ? $objA['mae_natural'] : null)); ?>">
                            </div>
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        var url = "<?php echo e(base_url() . "index.php/"); ?>";
