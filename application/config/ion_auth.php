...
$config['tables']['users_info']      = 'pessoas';
 ...
 */
$config['site_title']                 = "CREAS Ibitinga";       // Site Title, example.com
$config['admin_email']                = "admin@creas_ci.com"; // Admin Email, admin@example.com
